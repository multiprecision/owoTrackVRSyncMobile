...
public class KalmanGyroscopeSensor1 implements FSensor {
    private static final String TAG = KalmanGyroscopeSensor1.class.getSimpleName();
    ...
    public KalmanGyroscopeSensor1(Context context) {
    ...
    private void initializeFSensorFusions() {
        orientationFusionKalman = new OrientationFusedKalman1();
    }
