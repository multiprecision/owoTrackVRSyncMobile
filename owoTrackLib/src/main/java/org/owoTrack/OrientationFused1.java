...
public abstract class OrientationFused1 extends BaseFilter {
    ...
    private static final String tag = OrientationFused1.class.getSimpleName();
     ...
     */
    public OrientationFused1() {
        this(DEFAULT_TIME_CONSTANT);
    }

    public OrientationFused1(float timeConstant) {
